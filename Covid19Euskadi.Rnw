...
dateanditems <- jsonlite::fromJSON(covid19jsonurl, flatten=TRUE)
lastupdate <- dateanditems$lastUpdateDate
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \noindent Última actualización de los datos: \Sexpr{as.POSIXct(lastupdate,format="%Y-%m-%dT%H:%M:%S",tz=Sys.timezone())}
...
<<echo=FALSE, results=hide>>=
analisislist <- GetIrekiaCovid19AnalisisData(covid19jsonurl, spanishdataname="Análisis")
